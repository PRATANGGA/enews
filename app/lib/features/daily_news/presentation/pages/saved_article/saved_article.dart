...
class SavedArticles extends HookWidget {
  ...
  Widget _buildArticlesList(List<ArticleEntities> articles) {
    if (articles.isEmpty) {
      return const Center(
          child: Text(
        'NO SAVED ARTICLES',
  ...
  void _onRemoveArticle(BuildContext context, ArticleEntities article) {
    BlocProvider.of<LocalArticleBloc>(context)
        .add(DeleteArticle(article: article));
  }
